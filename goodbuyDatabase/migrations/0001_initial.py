# Generated by Django 2.2.5 on 2019-10-29 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_image', models.URLField(blank=True, null=True)),
                ('image_of_front', models.ImageField(blank=True, default='default.svg', null=True, upload_to='product_image')),
                ('image_of_details', models.ImageField(blank=True, default='default.svg', null=True, upload_to='product_image')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('scanned_counter', models.IntegerField(blank=True, default=1, null=True)),
                ...
                ('corporation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goodbuyDatabase.Corporation')),
                ('product_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goodbuyDatabase.CategoryOfProduct')),
            ],
            options={
                'db_table': 'products',
                'ordering': ('name', 'id'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('humans', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
                ('humans_description', models.TextField(blank=True, null=True)),
                ('environment', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
                ('environment_description', models.TextField(blank=True, null=True)),
                ('animals', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
                ('animals_description', models.TextField(blank=True, null=True)),
                ('corporation', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goodbuyDatabase.Corporation')),
            ],
            options={
                'db_table': 'ratings',
