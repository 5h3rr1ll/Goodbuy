...
from goodbuyDatabase.endpoints import is_product_in_db
...
class TestUrls(TestCase):
    ...
    def test_is_product_in_db(self):
        url = reverse(
            "goodbuyDatabase:is_product_in_db", args=["4000582185399"]
        )
        self.assertEqual(resolve(url).func, is_product_in_db)
    ...
    def test_show_list_of_codes(self):
        url = reverse(
            "goodbuyDatabase:show_list_of_codes", args=["4000582185399"]
        )
